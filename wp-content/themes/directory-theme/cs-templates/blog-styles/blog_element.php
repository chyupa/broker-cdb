                            ...
                            <div class="input-sec">
                              <div class="select-style">
                                <select name="cs_blog_view[]" class="dropdown">
                                  ...
                                  <option value="blog-small-thumb" <?php if($cs_blog_view == 'blog-small-thumb'){echo 'selected="selected"';}?>>Blog Small Thumb</option>
                                  ...
                                  <option value="blog-mesnory" <?php if($cs_blog_view == 'blog-mesnory'){echo 'selected="selected"';}?>>Blog Mesnory</option>
