        ...
        protected function do_plugin_install() {
            ...
            if ( isset( $_GET['plugin'] ) && ( isset( $_GET['tgmpa-install'] ) && 'install-plugin' == $_GET['tgmpa-install'] ) ) {
				...
				if(!get_option('cs_import_demo')){
					echo '<span class="import-btn cs-redirect-import"><a href="'.admin_url( "themes.php?page=cs_demo_importer").'">Install Demo Data</a></span>';
				}
 ...
 * @since 2.2.0
 */
if ( ! class_exists( 'WP_Upgrader' ) && ( isset( $_GET['page'] ) && "install-required-plugins" === $_GET['page'] ) ) {
