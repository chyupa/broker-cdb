                ...
                function cs_blog_post_general_options() {
                    ...
                    <li class="to-field">
                        <div class="input-sec">
                            <div class="select-style">
                                <select name="post_thumb_view" class="dropdown" onchange="javascript:new_toggle(this.value)">
                                    ...
                                    <option <?php if($post_thumb_view=="Video")echo "selected";?> value="Video" >Soundcloud</option>
                                </select>
                            </div>
                        </div>
                        <div class="left-info">
                        ...
                        <ul class="form-elements" id="post_thumb_video" style="display:<?php if($post_thumb_view=="Video")echo 'inline"';else echo 'none';?>" >                            
                            <li class="to-label"><label>Soundcloud URL</label></li>
                            <li class="to-field">
                                <div class="input-sec">
                                ...
                                <div class="left-info">
                                    <p>Enter Specific Soundcloud URL.</p>
                                </div>
                            </li>
                        </ul>
                </ul>
