                    ...
                    <div class="input-sec">
                      ...
                      <div class="select-style">
                        <select name="header_banner_style" class="dropdown" onchange="javascript:cs_slider_element_toggle(this.value)">
                          <option <?php if(isset($header_banner_style) and $header_banner_style=="default_header" || $header_banner_style=="" ){echo "selected";}?> value="default_header" ><?php _e('Default Subheader','dir');?></option>
                          <option <?php if(isset($header_banner_style) and $header_banner_style=="breadcrumb_header" ) {echo "selected";}?> value="breadcrumb_header" ><?php _e('Custom Subheader','dir');?></option>
                          ...
                          <option <?php if(isset($header_banner_style) and $header_banner_style=="no-header"){echo "selected";}?> value="no-header" ><?php _e('No Subheader','dir');?></option>
                        </select>
                        <script>
            ...
            <div id="subheader_custom_slider" <?php if(isset($header_banner_style) && $header_banner_style != '' && $header_banner_style == "custom_slider"){echo 'style="display:block"';} else {echo 'style="display:none"';} ?> >
              <ul class="form-elements">
                    ...
                    <li class="to-field">
                      ...
                      <div class="left-info">
                        <p>Please select Revolution Slider if already included in package. Otherwise buy Sliders from <a href="<?php _e('http://codecanyon.net/','dir');?>" target="_blank">Codecanyon</a>. But its optional</p>
                      </div>
                    </li>
              </ul>
              <ul class="form-elements">
                ...
                <li class="to-field">
                  <div class="select-style">
                   <select name="slider_position" id="slider_position">
                    <option value="below" <?php echo cs_allow_special_char($cs_slider_position) == 'below' ? 'selected="selected"' : '' ;?>>Below Header</option>
                      <option value="above" <?php echo cs_allow_special_char($cs_slider_position) == 'above' ? 'selected="selected"' : '' ;?>>Abover Header</option>
                   </select>
                  </div>
                </li>
              </ul>
