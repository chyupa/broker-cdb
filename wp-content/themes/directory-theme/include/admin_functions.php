                    ...
                    <div class="input-sec">
                      <div class="select-style">
                        <select name="cs_section_bg_image_repeat[]" class="select_dropdown">
                          <option value="repeat" <?php if ($cs_section_bg_image_repeat=='repeat')echo "selected";?>>Repeat</option>
                          <option value="no-repeat" <?php if ($cs_section_bg_image_repeat=='no-repeat')echo "selected";?>>No Repeat</option>
                        </select>
                      </div>
                    </div>
                  </li>
             ...
             <div class="cs-wrapp-class-<?php echo esc_attr($cs_counter);?> <?php echo esc_attr($shortcode_element);?>" id="<?php echo esc_attr($name.$cs_counter);?>" data-shortcode-template="[cs_event {{attributes}}]" style="display: none;">
                    ...
                    <div class="cs-pbwp-content">
                      ...
                      <?php if(isset($_POST['shortcode_element']) && $_POST['shortcode_element'] == 'shortcode'){?>
                          <ul class="form-elements">
                            <li class="to-field"> <a class="insert-btn cs-main-btn" onclick="javascript:Shortcode_tab_insert_editor('<?php echo esc_js(str_replace('cs_pb_','',$name));?>','<?php echo esc_js($name.$cs_counter);?>','<?php echo esc_js($filter_element);?>')" >Insert</a> 
                            </li>
                          </ul>
    ...
    <div class="poped-up" id="edit_track_form<?php echo esc_attr($counter_social);?>">
          ...
          <ul class="form-elements">
                ...
                <li class="to-field">
                  ...
                  <p>Put Fontawsome icon/image url. You can get fontawsome icons from <a href="<?php _e('http://fortawesome.github.io/Font-Awesome/icons/','dir')?>">here</a></p>
                </li>
          </ul>
          <ul class="form-elements">
                <li class="to-label">
                ...
                <td colspan="3">
                  <ul class="form-elements">
                    ...
                    <li class="to-field select-style">
                      ...
                      <p>Please enter Banner Banner Style.</p>
                    </li>
                    <li class="full">&nbsp;</li>
                    <li class="to-label">
